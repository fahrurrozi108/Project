...
include '../../config.php';
$no = 1;
$data = mysqli_query($koneksi,"select a.no_pemesanan,a.tgl_pemesanan,(select b.nama_paket from tb_paket AS b where b.id_paket like a.id_paket),a.harga_satuan,a.jumlah,(select b.ongkir from tb_paket as b where b.id_paket like a.id_paket),a.file,a.status from tb_pemesanan as a where a.id_pelanggan like ".$_SESSION['id_pelanggan'] );
